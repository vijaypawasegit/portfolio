...
! function(a, b, c, d) {
    ...
    var g = {
            ...
            updateSinglePage: function(b) {
                var c, d, e = this;
                e.content.html(b), e.wrap.addClass("cbp-popup-ready"), e.wrap.removeClass("cbp-popup-loading"), e.counter && (d = a(e._getCounterMarkup(e.options.singlePageCounter, e.current + 1, e.counterTotal)), e.counter.text(d.text())), c = e.content.find(".cbp-slider"), c ? (e.slider = Object.create(h), e.slider._init(e, c)) : e.slider = null
            },
        ...
        i = {
            ...
            _display: function() {
                ...
                "responsive" === e.options.gridAdjustment && e._responsiveLayout(), e._layout(), e._processStyle("css"), e._resizeMainContainer("css"), ("lazyLoading" === e.options.displayType || "fadeIn" === e.options.displayType) && e.$ul.animate({
                    ...
                    e.$obj.removeClass("cbp-loading"), e._triggerEvent("initFinish"), e.$obj.trigger("initComplete"), e.$obj.addClass("cbp-ready")
                }, 0), e.lightbox = null, e.$obj.find(e.options.lightboxDelegate) && (e.lightbox = Object.create(g), e.lightbox.init(e, "lightbox"), e.$obj.on("click" + f, e.options.lightboxDelegate, function(a) {
                    a.preventDefault(), e.lightbox.openLightbox(e.blocksAvailable.find(e.options.lightboxDelegate), this)
                })), 1 != h.data("cbpLightboxIsOn") && (h.on("click" + f, e.options.lightboxDelegate, function(b) {
                    b.preventDefault();
                    var c = a(this),
                        d = c.data("cbpLightbox");
                    c.closest(a(".cbp")).length || (d ? e.lightbox.openLightbox(a(e.options.lightboxDelegate).filter("[data-cbp-lightbox=" + d + "]"), this) : e.lightbox.openLightbox(c, this))
